java -jar "compiler.jar" ^
  ...
  --closure_entry_point=montigo.page.Activities ^
  ...
  --create_source_map=..\js\montigo-page-activities.min.map ^
  --source_map_format=V3 ^
  --js_output_file=..\js\minified\montigo-page-activities.min.js

echo //@ sourceMappingURL=http://localhost/git/montigo/js/montigo-page-activities.min.map >> ..\js\minified\montigo-page-activities.min.js
