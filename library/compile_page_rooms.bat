java -jar "compiler.jar" ^
  ...
  --closure_entry_point=montigo.page.Rooms ^
  ...
  --create_source_map=..\js\montigo-page-rooms.min.map ^
  --source_map_format=V3 ^
  --js_output_file=..\js\minified\montigo-page-rooms.min.js

echo //@ sourceMappingURL=http://localhost/git/montigo/js/montigo-page-rooms.min.map >> ..\js\minified\montigo-page-rooms.min.js
