java -jar "compiler.jar" ^
  ...
  --closure_entry_point=montigo.page.Spa ^
  ...
  --create_source_map=..\js\montigo-page-spa.min.map ^
  --source_map_format=V3 ^
  --js_output_file=..\js\minified\montigo-page-spa.min.js

echo //@ sourceMappingURL=http://localhost/git/montigo/js/montigo-page-spa.min.map >> ..\js\minified\montigo-page-spa.min.js
