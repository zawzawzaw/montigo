java -jar "compiler.jar" ^
  ...
  --closure_entry_point=montigo.page.Faq ^
  ...
  --create_source_map=..\js\montigo-page-faq.min.map ^
  --source_map_format=V3 ^
  --js_output_file=..\js\minified\montigo-page-faq.min.js

echo //@ sourceMappingURL=http://localhost/git/montigo/js/montigo-page-faq.min.map >> ..\js\minified\montigo-page-faq.min.js
