java -jar "compiler.jar" ^
  ...
  --closure_entry_point=montigo.page.Home ^
  ...
  --create_source_map=..\js\montigo-page-home.min.map ^
  --source_map_format=V3 ^
  --js_output_file=..\js\minified\montigo-page-home.min.js

echo //@ sourceMappingURL=http://localhost/git/montigo/js/montigo-page-home.min.map >> ..\js\minified\montigo-page-home.min.js
