java -jar "compiler.jar" ^
  ...
  --closure_entry_point=montigo.page.Default ^
  ...
  --create_source_map=..\js\montigo-page-default.min.map ^
  --source_map_format=V3 ^
  --js_output_file=..\js\minified\montigo-page-default.min.js

echo //@ sourceMappingURL=http://localhost/git/montigo/js/montigo-page-default.min.map >> ..\js\minified\montigo-page-default.min.js
