java -jar "compiler.jar" ^
  ...
  --closure_entry_point=montigo.page.Dining ^
  ...
  --create_source_map=..\js\montigo-page-dining.min.map ^
  --source_map_format=V3 ^
  --js_output_file=..\js\minified\montigo-page-dining.min.js

echo //@ sourceMappingURL=http://localhost/git/montigo/js/montigo-page-dining.min.map >> ..\js\minified\montigo-page-dining.min.js
