...
<div id="main-page-content">
  ...
  <!-- 
    ...
    | |_ / _ \ \ / / | | | |_) || |  | | |  _| \___ \ 
    |  _/ ___ \ V /| |_| |  _ < | |  | | | |___ ___) |
    |_|/_/   \_\_/  \___/|_| \_\___| |_| |_____|____/ 
  ...
  <div id="activities-favorites-section">
          ...
          <div id="activities-favorite-item-container-row-container">
            ...
            <div class="col-md-2">
              <div class="activities-favorite-item">
                ...
                <hr class="short-hr">
                <p>Depart by hotel car to Nongsa Forest. Trek uphill for a mid-morning refreshment, then across the primary forest to spot wildlife and plants indigenous to the region.</p>
              </div>
            </div>
            ...
            <div class="col-md-2">
              <div class="activities-favorite-item">
                ...
                <hr class="short-hr">
                <p>With a Montigo guide, cycle from to nearby Pantai Village to explore a traditional Indonesian ‘kampong’ village. Catch a glimpse of daily life in Batam.</p>
              </div>
            </div>
    ...
    </div> <!-- #activities-favorite-item-container -->

    <div id="activities-favorite-cta-button-container">
      <a href="mailto:info@montigoresorts.com?subject=Montigo%20Activities%3A%20Book%20Activities" class="cta-button">After booking your stay at Montigo Resorts, Nongsa, <br>contact us to book your activities!<span class="fa fa-chevron-circle-right"></span></a>
    </div>
            ...
            <div id="activities-terrestrial-text-panel-container" class="panel-container description-list-panel-container">
              <div class="panel-container-container">
                <div class="panel panel-01 description-panel">
                  ...
                  <div id="activities-terrestrial-text-description-panel" class="montigo-image-description">
                ...
                <div class="panel panel-02 list-panel">
                  ...
                  <a href="mailto:info@montigoresorts.com?subject=Montigo%20Activities%3A%20Rates%20%26%20Schedules%20Enquiry" class="cta-small-v2-button">Please get in touch with the resort concierge or <br>info@montigoresorts.com for rates and schedules.<span class="fa fa-chevron-circle-right"></span></a>
            ...
            <div id="activities-sea-text-panel-container" class="panel-container description-list-panel-container">
              <div class="panel-container-container">
                <div class="panel panel-01 description-panel">
                  ...
                  <div id="activities-sea-text-description-panel" class="montigo-image-description">
                    <div class="montigo-image-description-container">
            ...
            <div id="activities-fitness-text-panel-container" class="panel-container description-list-panel-container">
              <div class="panel-container-container">
                <div class="panel panel-01 description-panel">
                  ...
                  <div id="activities-fitness-text-description-panel" class="montigo-image-description">
                    <div class="montigo-image-description-container">
  ...
  <div id="activities-parallax-01" class="parallax-section pin-version" data-image="images/parallax/may20_activities_parallax_olu.jpg"  data-horizontal-crop="left" data-vertical-crop="bottom">
    ...
    <div class="parallax-section-text-container">
      <div class="text-container" data-width="1440" data-height="900">
        <!-- <div id="activities-parallax-01-text" class="parallax-section-text white-version text" data-x="304" data-y="390"> -->
        <div id="activities-parallax-01-text" class="parallax-section-text white-version text" data-x="304" data-y="490">
          ...
          <a href="mailto:info@montigoresorts.com?subject=Montigo%20Activities%3A%20Olo%20Kids%20Club%20Enquiry" class="cta-button fadein-top">get in touch with montigo <span class="fa fa-chevron-circle-right"></span></a>
  ...
  <div id="activities-others" class="icon-set-section">
        ...
        <div class="row">
          ...
          <div class="col-md-3 col-sm-6 col-xs-6">
            <div class="icon-set-item">
              ...
              <h4>Chef experience</h4>
              <hr class="short-hr">
              <p>Learn to prepare a menu of Indonesian home-style favourites using herbs you picked and fish you caught.</p>
            </div>
          </div>
          ...
          <div class="col-md-3 col-sm-6 col-xs-6">
            <div class="icon-set-item">
              ...
              <h4>Paintball</h4>
              <hr class="short-hr">
              <p>Pick up that adrenaline level by engaging in a game of paintball with your friends and family.Defence, now attack!</p>
            </div>
          </div>
          ...
          <div class="col-md-3 col-sm-6 col-xs-6">
            <div class="icon-set-item">
              ...
              <hr class="short-hr">
              <p>Learn about various healing herbs, then have a hand at creating your own herbal bouquet. End the session with a herbal back massage.</p>
            </div>
          </div>
          ...
          <div class="col-md-3 col-sm-6 col-xs-6">
            <div class="icon-set-item">
              ...
              <h4>Karaoke</h4>
              <hr class="short-hr">
              <p>Prep those lungs for a session of Steve Tyler or shake it off like Taylor Swift. With private Rooms, we’re sure you’ll emerge ready to take on the stage.</p>
            </div>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-md-3 col-sm-6 col-xs-6">
            <div class="icon-set-item">
              ...
              <h4>Batik painting</h4>
              <hr class="short-hr">
              <p>This wax resistant method of dyeing fabric is beautiful and fun. Learn the secrets to this unique art form and create your own design to take home.</p>
            </div>
          </div>
          ...
          <div class="col-md-3 col-sm-6 col-xs-6">
            <div class="icon-set-item">
              ...
              <hr class="short-hr">
              <p>If you’re looking for a bit more privacy, our private dining experience will fit the bill. We will tailor it to exactly how you would like it to be.</p>
            </div>
          </div>
          ...
          <div class="col-md-3 col-sm-6 col-xs-6">
            <div class="icon-set-item">
              ...
              <h4>Tilo treasure hunt</h4>
              <hr class="short-hr">
              <p>Embark on a grand adventure as you cross the resort in search of clues and hints. Complete the hunt, return to the starting point and claim your prize!</p>
            </div>
          </div>
          ...
          <div class="col-md-3 col-sm-6 col-xs-6">
            <div class="icon-set-item">
              ...
              <h4>Spa</h4>
              <hr class="short-hr">
              <p>Restore your body’s balance with centuries old therapies. Recharge and be holistically revived through the Montigo Spa treatments.</p>
            </div>
          </div>
    ...
    <div class="icon-set-cta-button-container">
      <div class="icon-set-cta-button-container-container">
        <a href="mailto:info@montigoresorts.com?subject=Montigo%20Activities%3A%20Rates%20%26%20Schedules%20Enquiry" id="activities-other-cta-button" class="cta-button">Please get in touch with the resort concierge or <br>info@montigoresorts.com for rates and schedules.<span class="fa fa-chevron-circle-right"></span></a>
      </div>
    </div>
  ...
  jQuery(document).ready(function($) {
    $.manic_preloader({
      asset_array: [
        ...
        "images/activities/favorites_04.jpg",
        "images/activities/favorites_05.jpg",
        "images/activities/favorites_06.jpg",
        "images/activities/sea_activities_01b_yatch.jpg",
        "images/activities/terrestrial_activities_01.jpg",
        "images/activities/fitness_activities_01b.jpg",

        "images/icons/activities_icon_01_chef.png",
        "images/icons/activities_icon_02_paintball.png",
        "images/icons/activities_icon_03_herbal_compress.png",
        "images/icons/activities_icon_04_karaoke.png",
        "images/icons/activities_icon_05_batik_painting.png",
        "images/icons/activities_icon_06_dining.png",
        "images/icons/activities_icon_07_treasure_hunt.png",
        "images/icons/activities_icon_08_spa.png"
      ],
      desktop_js_array: [
        <?php if(DEBUG): ?>
