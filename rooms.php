    ...
    <div class="text-container" id="specific-copy-03">
      <div class="one-long-text">
        <div class="text">
          ...
          <div id="rooms-slider-text">
            <div class="bg-black-gradient"></div>
            <h3>Accomodating<br>Generation</h3>
          ...
          <div class="row">
            ...
            <div class="col-md-4">
              ...
              <div id="rooms-residences-text">
                ...
                <p>Exclusive and exquisite, the Montigo Residences are ideal destinations for your next holiday. Each well-appointed residence features a unique configuration. There are three modern en-suite bedrooms, along with a living and dining room, kitchen, powder room, and an expansive terrace with 
multiple plunge pools and cabanas.</p>
