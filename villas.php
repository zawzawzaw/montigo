...
<div id="main-page-content">
            ...
            <div class="panel-container-container">
              <div class="panel">
                <div class="manic-image-container">
                  <img src="images/rooms/rooms_villas_image_01.jpg">
                </div>
              </div>
              <div class="panel">
                <div class="manic-image-container">
            ...
            <div id="room-villas-text-panel-container" class="panel-container">
              ...
              <div class="panel-container-container">
                ...
                <div class="panel">
                  ...
                  <p>Lorem ipsum dolor sit amet, consectetuer elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec quam felis, pellentesque eu, pretium. </p>
                  <p>Nulla consequat massa quis enim.Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec quam felis, ultricies nec, pellentesque.</p>
                  <!-- <p>Majestically dotting our resort’s crest, hilltop villas offer both, uninterrupted views of the sea and lush greenery.</p> -->
                </div>
                <div class="panel">
                  <h4>Seafront villas</h4>
                  <p>Lorem ipsum dolor sit amet, consectetuer elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec quam felis, pellentesque eu, pretium. </p>
                  <p>Nulla consequat massa quis enim.Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec quam felis, ultricies nec, pellentesque.</p>
                  <!-- <p>With unobstructed views of the South China Sea, our seafront villas are as breathtaking as the panoramas they open windows to.</p> -->
                </div>
                <div class="panel">
                  <h4>Hillside villas</h4>
                  <p>Lorem ipsum dolor sit amet, consectetuer elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec quam felis, pellentesque eu, pretium. </p>
                  <p>Nulla consequat massa quis enim.Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec quam felis, ultricies nec, pellentesque.</p>
                  <!-- <p>Our hillside accommodation sprawls between our hilltop and seafront villas. They offer excellent access to all that our resort has to offer.</p> -->
                </div>
                <div class="panel">
                  <h4>Spa villas</h4>
                  <p>Lorem ipsum dolor sit amet, consectetuer elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec quam felis, pellentesque eu, pretium. </p>
                  <p>Nulla consequat massa quis enim.Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec quam felis, ultricies nec, pellentesque.</p>
                  <!-- <p>With their own individual private cabana, the spa villas are conveniently located for an indulgent escape to the Montigo Spa.</p> -->
                </div>
                <div class="panel">
                  <h4>The residences</h4>
                  <p>Lorem ipsum dolor sit amet, consectetuer elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec quam felis, pellentesque eu, pretium. </p>
                  <p>Nulla consequat massa quis enim.Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec quam felis, ultricies nec, pellentesque.</p>
                  <!-- <p>The best accommodation Montigo has to offer, these three bed residences are both, exquisite and exclusive.</p> -->
                </div>
  ...
  </div> <!-- rooms-villas-section -->

  <!-- 
        _    __  __ _____ _   _ ___ _____ ___ _____ ____  
       / \  |  \/  | ____| \ | |_ _|_   _|_ _| ____/ ___| 
      / _ \ | |\/| |  _| |  \| || |  | |  | ||  _| \___ \ 
     / ___ \| |  | | |___| |\  || |  | |  | || |___ ___) |
    /_/   \_\_|  |_|_____|_| \_|___| |_| |___|_____|____/ 
  ...
  </div> <!-- rooms-amenities-header-section -->


  <div id="rooms-amenities-section">
    ...
    <div class="container-fluid has-breakpoint">
      <div class="row">
        ...
        <div class="col-md-4">
          ...
          <div id="rooms-amenities-text-01">
            <h4>all villas feature the following &amp; have the same structural layout</h4>
            <hr class="short-hr">
            <ul>
              <li>Sky terrace</li>
  ...
  </div> <!-- rooms-amenities-section -->

  <!-- 
     ____  _____ ____ ___ ____  _____ _   _  ____ _____ ____  
    |  _ \| ____/ ___|_ _|  _ \| ____| \ | |/ ___| ____/ ___| 
    | |_) |  _| \___ \| || | | |  _| |  \| | |   |  _| \___ \ 
  ...
  <div id="rooms-residences-section" class="parallax-section" data-image="images/parallax/rooms_residences_parallax_balcony_01.jpg">
    ...
    <div class="parallax-section-text-container">
      <div class="text-container" data-width="1276" data-height="896">
        <div id="rooms-residences-text" class="parallax-section-text text" data-x="1048" data-y="363">
          ...
          <p>Exclusive and exquisite, the Montigo Residences are ideal destinations for your next holiday. Each well-appointed residence features a unique configuration. There are three modern en-suite bedrooms, along with a living and dining room, kitchen, powder room, and an expansive terrace with multiple plunge pools and cabanas.</p>
